    ...
    extends AbstractHBCICallback 
{
     ...
     * @param dialog Stream, der für das Einlesen von Antworten verwendet wird */
    public HBCICallbackIOStreams(TestUmsatzAbrufen kausz)
    {
    	this.dialog = new DialogBuffer(kausz);
    	kausz.setDialogBuffer(this.dialog);
    }
...
//    }
    ...
    /** Gibt des INPUT-Stream zurück. */
    protected DialogBuffer getInStream() {
        return dialog;
    }

    /** Gibt den verwendeten OUTPUT-Stream zurück. */
    protected DialogBuffer getOutStream() {
        return dialog;
    }
