...
import org.rochlitz.hbci.tests.apps.DialogBuffer;
import org.rochlitz.hbci.tests.apps.TestUmsatzAbrufen;
...
public class MainActivity extends Activity 
	...
	private TestUmsatzAbrufen kausz;
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	kausz = (TestUmsatzAbrufen) new TestUmsatzAbrufen( getApplicationContext().getFilesDir() ) {
...
//	}
	...
	public void openDialog2(DialogBuffer dialogBuffer) {
...
//			}
			builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int whichButton) {
					...
					Toast.makeText(getApplicationContext(), inputText,
							Toast.LENGTH_SHORT).show();
					kausz.getDialog().setInputFinished(true);
					kausz.getDialog().setUserInput(inputText);
				}
			});
			builder.setMessage(dialogBuffer.getDialogOutput());
			builder.setNegativeButton("Cancel", null);
			actions = builder.create();
			setContentView(button);
		} catch (Exception e) {
